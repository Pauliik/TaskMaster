...
class Task_filter(django_filters.FilterSet):
    name_task = django_filters.CharFilter(field_name='name_task', lookup_expr='icontains', label="Поиск по тексту")
...
class Mytask_filter(django_filters.FilterSet):
    text_search = django_filters.CharFilter(method='my_custom_filter', label="Поиск по тексту")
...
class Project_filter(django_filters.FilterSet):
    name = django_filters.CharFilter(field_name='name', lookup_expr='icontains', label="Поиск по тексту")
